...
public class AppOpenManager implements LifecycleObserver, Application.ActivityLifecycleCallbacks {
    ...
    public void fetchAd() {
        try {
            ...
            AppOpenAd.load(
                    myApplication, myApplication.getResources().getString(R.string.applock_ads_open_id), request,
    ...
    public void showAdIfAvailable() {
        if (!isShowingAd && isAdAvailable() && AdsManager.INSTANCE.getCurrentAdClickEventCount() < AdsManager.INSTANCE.getMaxAdClickEventCountForOneSessionPerUser()
        && !BillingClientSetup.isUpgraded(myApplication)) {
            FullScreenContentCallback fullScreenContentCallback =
                    new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            ...
                            AdsManager.INSTANCE.setAdsType(AdsManager.TYPE_ADS_OPEN);
                        ...
                        public void onAdClicked() {
                            ...
                            Utils.INSTANCE.setTrackAdClickEvent(myApplication, Constants.OPEN,"","");
                        }
                    };
            ...
            appOpenAd.setOnPaidEventListener(new OnPaidEventListener() {
                ...
                public void onPaidEvent(@NonNull AdValue adValue) {
                    ...
                    Utils.INSTANCE.setTrackAdRevenueByAdjust(adValue.getValueMicros(),adValue.getCurrencyCode());
                    Utils.INSTANCE.setTrackPaidAdEvent(myApplication,adValue, Constants.OPEN);
                }
            });
