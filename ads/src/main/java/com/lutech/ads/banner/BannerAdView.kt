...
import com.lutech.ads.banner.BannerPlugin.Companion.log
...
internal class BannerAdView(
    ...
    init {
        ...
        adView.setOnPaidEventListener {
            ...
            Utils.setTrackPaidAdEvent(context,it, Constants.BANNER)
        }
    ...
    override fun loadAdInternal(onFailedCallback: () -> Unit, onDone: () -> Unit) {
        if (!hasSetAdSize) {
            doOnLayout {
                ...
                hasSetAdSize = true
                doLoadAd(onFailedCallback, onDone)
            }
        } else {
            doLoadAd(onFailedCallback, onDone)
        }
    ...
    private fun doLoadAd(onFailedCallback: () -> Unit,onDone: () -> Unit) {
...
//                adView.adListener = object : AdListener() {}
            ...
            override fun onAdClicked() {
                ...
                adView.isVisible = AdsManager.currentAdClickEventCount < AdsManager.MaxAdClickEventCountForOneSessionPerUser
