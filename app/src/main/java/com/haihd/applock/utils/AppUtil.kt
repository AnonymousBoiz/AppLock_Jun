...
object AppUtil {
    ...
    val listPkgHotApp = mutableListOf(
        "com.facebook.katana",
        "com.sec.android.gallery3d",
        "com.facebook.orca",
    ...
    val listPkSocialApp = mutableListOf(
        "com.discord",
        "com.facebook.katana",
        "com.google.android.gm",
        "com.facebook.orca"
    ...
    val listPkPlayerApp = mutableListOf(
        "com.google.android.youtube"
    )
    val listPkPaymentApp = mutableListOf(
        ""
    )
    val listPkGameApp = mutableListOf(
        ""
    )
