package com.haihd.applock.activity.lock
...
import com.haihd.applock.databinding.ActivityLockScreenBinding
import com.haihd.applock.dialog.DialogQuestion
import com.haihd.applock.key.*
...
class LockActivity : BaseActivity<ActivityLockScreenBinding>(), CameraCallbacks {
    ...
    override fun initView() {
        AdsManager.loadNativeAds(this, binding.myTemplate, com.lutech.ads.R.string.applock_native_home_id)
...
//        loadAds()
    ...
    @KoinApiExtension
    private fun passWordCorrect(forgotPassword: Boolean = false) {
