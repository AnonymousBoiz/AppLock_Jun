package com.haihd.applock.activity.album
...
import com.haihd.applock.adapter.AlbumAdapter
import com.haihd.applock.dialog.DialogDeleteImage
import com.haihd.applock.dialog.DialogHiding
import com.haihd.applock.dialog.DialogReadMediaPermission
...
import com.haihd.applock.activity.vault.LockFileSuccessActivity
import com.haihd.applock.databinding.ActivityAlbumImageBinding
import com.haihd.applock.databinding.LayoutDialogDeleteImageBinding
import com.haihd.applock.key.KEY_COUNT
import com.haihd.applock.key.REQUEST_CODE_READ_MEDIA_PMS
import com.lutech.ads.AdsManager
import org.koin.android.ext.android.inject
import java.io.File


class AlbumImageActivity : BaseActivity<ActivityAlbumImageBinding>() {
...
//
        adapterAlbum = AlbumAdapter(this, listDetailPhoto)
...
//            showDialogDeleteImage(getString(R.string.delete_after_hiding))
    ...
    override fun viewBinding(): ActivityAlbumImageBinding {
        return ActivityAlbumImageBinding.inflate(LayoutInflater.from(this))
    }
