package com.haihd.applock.activity.notification
...
import com.haihd.applock.adapter.DetailNotificationAdapter
import com.haihd.applock.databinding.ActivityDetailNotificationBinding
...
import com.haihd.applock.viewmodel.NotifyViewModel
...
class DetailNotificationActivity : BaseActivity<ActivityDetailNotificationBinding>() {
    ...
    override fun viewBinding(): ActivityDetailNotificationBinding {
        return ActivityDetailNotificationBinding.inflate(LayoutInflater.from(this))
    }
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        launchActivity<HomeActivity> { flags = Intent.FLAG_ACTIVITY_CLEAR_TASK }
    }
