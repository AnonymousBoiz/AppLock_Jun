package com.haihd.applock.activity.locktype
...
import com.haihd.applock.databinding.ActivityLockTypeBinding
...
class LockTypeActivity : BaseActivity<ActivityLockTypeBinding>() {
...
//        checkCreateLock() //
    ...
    override fun viewBinding(): ActivityLockTypeBinding {
        return ActivityLockTypeBinding.inflate(LayoutInflater.from(this))
    }
