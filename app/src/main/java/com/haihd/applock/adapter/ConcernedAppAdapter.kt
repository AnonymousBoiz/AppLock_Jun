...
import com.haihd.applock.databinding.LayoutItemConcernedAppBinding
import com.haihd.applock.item.ItemAppLock
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter

class ConcernedAppAdapter(val context: Context, list: MutableList<ItemAppLock>) :
    BaseRecyclerAdapter<ItemAppLock, ConcernedAppAdapter.ViewHolder>(context, list) {
