...
import com.haihd.applock.databinding.LayoutItemVideoHideBinding
import com.haihd.applock.item.ItemVideoHide
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter
import java.io.File
import java.text.SimpleDateFormat

class VideoHideAdapter(var context: Context, list: MutableList<ItemVideoHide>) :
    BaseRecyclerAdapter<ItemVideoHide, VideoHideAdapter.ViewHolder>(context, list) {
