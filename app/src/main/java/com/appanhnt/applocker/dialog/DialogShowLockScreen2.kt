...
import com.appanhnt.applocker.databinding.LayoutDialogShowLockScreenBinding

class DialogShowLockScreen2(context: Context, var drawable: Drawable?, style: Int) :
