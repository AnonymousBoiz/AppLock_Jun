...
import com.appanhnt.applocker.activity.ActivitySameImage
import com.appanhnt.applocker.activity.ActivitySearchRestore
import com.appanhnt.applocker.activity.ActivityVault
import com.appanhnt.applocker.activity.CleanActivity
import com.appanhnt.applocker.activity.IntrusionAlertActivity
import com.appanhnt.applocker.activity.ThemeActivity
import com.appanhnt.applocker.activity.Trans
...
import com.appanhnt.applocker.adapter.AdapterProtected
            ...
            dialogPermission = DialogPermission(
                ...
                object : DialogPermission.Callback {
                    ...
                    override fun onGoProtectApp() {
                        if (!BackgroundManager.isIgnoringBatteryOptimizations(this@MainLockActivity)) {
                            requestIgnoreBatteryOptimize()
                        }
                    }

                    override fun onGoSettings() {
                        if (!BackgroundManager.isAccessGranted(this@MainLockActivity)) {
                            showDialogPermission(false)
                        } else if (!Settings.canDrawOverlays(this@MainLockActivity)){
                            showDialogPermission(true)
                        }else if (!BackgroundManager.isIgnoringBatteryOptimizations(this@MainLockActivity)) {
                            requestIgnoreBatteryOptimize()
                        }
                    }
