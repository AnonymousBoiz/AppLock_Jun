...
import com.appanhnt.applocker.activity.CreateQuestion
...
import com.anhnt.baseproject.extensions.newIntent
...
class SettingsActivity : BaseActivity<ActivitySettingsBinding>() {
    ...
    private fun changePasswordType(type: String){
        ...
        if (!PreferencesUtils.getBoolean(type)){
            val intent = Intent(this, CreateLockActivity::class.java)
            val bundle = Bundle()
