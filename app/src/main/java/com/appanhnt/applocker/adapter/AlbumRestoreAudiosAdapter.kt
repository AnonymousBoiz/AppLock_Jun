...
import com.appanhnt.applocker.databinding.LayoutItemAlbumRestoreAudioBinding
import com.appanhnt.applocker.item.ItemAlbumRestoreAudios
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter
import java.io.File

class AlbumRestoreAudiosAdapter(var context: Context, list: MutableList<ItemAlbumRestoreAudios>) :
    BaseRecyclerAdapter<ItemAlbumRestoreAudios, AlbumRestoreAudiosAdapter.ViewHolder>(
        context,
        list
    ) {
