...
import com.appanhnt.applocker.databinding.LayoutItemAlbumRestoreVideosBinding
import com.appanhnt.applocker.item.ItemAlbumRestoreVideos
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter
import java.io.File

class AlbumRestoreVideoAdapter(var context: Context, list: MutableList<ItemAlbumRestoreVideos>) :
    BaseRecyclerAdapter<ItemAlbumRestoreVideos, AlbumRestoreVideoAdapter.ViewHolder>(
        context,
        list
    ) {
