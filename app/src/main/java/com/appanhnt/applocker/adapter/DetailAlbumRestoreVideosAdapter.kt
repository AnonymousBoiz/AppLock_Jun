...
import com.appanhnt.applocker.databinding.LayoutItemRestoreVideoBinding
import com.appanhnt.applocker.item.ItemVideoRestore
import com.appanhnt.applocker.utils.AppUtil
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter

class DetailAlbumRestoreVideosAdapter(var context: Context, list: MutableList<ItemVideoRestore>) :
    BaseRecyclerAdapter<ItemVideoRestore, DetailAlbumRestoreVideosAdapter.ViewHolder>(
        context,
        list
    ) {
