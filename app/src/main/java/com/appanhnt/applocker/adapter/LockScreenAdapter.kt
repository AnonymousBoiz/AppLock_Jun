...
import com.appanhnt.applocker.databinding.LayoutItemLockScreenBinding
import com.appanhnt.applocker.item.ItemLockScreen
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter


class LockScreenAdapter(var context: Context, list: MutableList<ItemLockScreen>) :
    BaseRecyclerAdapter<ItemLockScreen, LockScreenAdapter.ViewHolder>(context, list) {
