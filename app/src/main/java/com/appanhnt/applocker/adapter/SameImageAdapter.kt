...
import com.appanhnt.applocker.databinding.LayoutItemSameImageBinding
import com.appanhnt.applocker.item.ItemSameImage
import com.anhnt.baseproject.adapter.BaseRecyclerAdapter

class SameImageAdapter(var context: Context, list: MutableList<ItemSameImage>) :
    BaseRecyclerAdapter<ItemSameImage, SameImageAdapter.ViewHolder>(context, list) {
