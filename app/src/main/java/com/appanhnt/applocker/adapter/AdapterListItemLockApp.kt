...
class AdapterListItemLockApp(val context: Context, var list: MutableList<ItemListAppLock>,val callback: AdapterListItemLockApp.Callback) :
    RecyclerView.Adapter<AdapterListItemLockApp.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val adapter = AdapterItemLockApp(context, data.list, object : AdapterItemLockApp.Callback {
